    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1">
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8 mt-8">
                            <Card>
                                ...
                                <CardContent>
                                    <p>Support up to 3 teams from different leagues and get personalized updates.</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p>Automatic live score updates for all the teams you follow.</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p>Never miss a match with timely notifications for your favorite teams.</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                    <CardTitle>XLM Staking</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <p>Stake your tokens on match outcomes and earn rewards on Stellar.</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p>Collect, trade, and showcase digital player cards on the blockchain.</p>
                                </CardContent>
                            </Card>
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <p>Get intelligent match predictions powered by advanced AI analysis.</p>
                                </CardContent>
                            </Card>
                        </div>
                    </div>
                ...
                <section id="premium" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
                    <div className="container px-4 md:px-6">
                        <div className="flex flex-col items-center justify-center space-y-4 text-center">
                            <div className="space-y-2">
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Premium Access</h2>
                                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                        ...
                        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8 mt-8">
                                ...
                                <CardContent className="space-y-4">
                                    <ul className="space-y-2">
                                        ...
                                        <li className="flex items-center">
                                            ...
                                            <span>Basic Stellar staking</span>
                                        </li>
                                    </ul>
                                </CardContent>
                                <CardFooter>
                            ...
                            <Card className="border-primary">
                                <CardHeader>
                                    ...
                                    <CardDescription>Enhanced features for true fans</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <ul className="space-y-2">
                                        <li className="flex items-center">
            ...
            <footer className="w-full border-t py-6 md:py-0">
                <div className="container flex flex-col items-center justify-between gap-4 md:h-16 md:flex-row">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm text-muted-foreground">© 2025 Renaissance. All rights reserved.</p>
                    </div>
